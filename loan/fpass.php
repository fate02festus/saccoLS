...
if (isset($login)) {
    ...
    */
    if($_POST['pass']==$_POST['cpass'])
    {
        ...
        $que = mysqli_query($conn, "select * from users where username='$email' ");
        $row = mysqli_num_rows($que);
        $r = mysqli_fetch_array($que);
        if ($row) {
            mysqli_query($conn, "update users set password='$passw' where username='" . $email . "'");
            //and password='$passw'
...
<head>
    ...
    <title>LOAN SYSTEM FORGET PASSWORD</title>
                ...
                <form method="post">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" id="exampleInputPassword1" name="cpass">
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>

                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="login">Forget Password <i class="ti-arrow-right"></i></button>
